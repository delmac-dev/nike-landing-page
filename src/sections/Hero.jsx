  ...
  return (
    <section id='home' className='w-full flex xl:flex-row flex-col min-h-screen gap-10 max-container'>
        ...
        <div className='flex justify-start items-start flex-wrap w-full mt-20 gap-16'>
          {statistics.map((stat, index) => (
            <div key={index}>
              ...
              <p className='leading-7 font-slate-gray font-montserrat'>{stat.label}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className='relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-center'>
        <img src={bigShoeImg} alt="big collection" width={610} height={500} className='object-contain relative z-10'/>
